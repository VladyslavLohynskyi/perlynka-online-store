            ...
            <>
               ...
               <div className='shoes-page__characteristics-container'>
                  ...
                  >
                     ...
                     >
                        <p>
                           Оплату товару можна здійснити наступними методами:
                        </p>
                        <ul>
                           <li>
                     ...
                     >
                        <ul>
                           <li>
                              доставка по Україні службою доставки "Нова пошта"
                              (на відділення або до дверей);
                           </li>
                           <li>
                              у м.Львові є можливість забрати замовлення з
                              магазину за адресою вул. Щирецька 36, ТВК
                              "Південний", ТЦ 'Калина' 2А;
                           </li>
                        </ul>
                     </DescriptionsItem>
                     <DescriptionsItem
                     ...
                     >
                        ...
                        <p>
                           Повернення необхідно оформити як звичайну посилку
                           (без накладного платежу). Всі витрати при цьому несе
                           покупець. Важливо! Не обклеюйте фірмову коробку
                           кросівок клейкою стрічкою - такі повернення не будуть
                           розглянуті.
                        </p>
                        <p>
                           Повернення коштів за товар здійснюється за
                           реквізитами. Строк перерахування коштів – до 7
                           робочих днів після отримання та перевірки поверненого
                           товару.
                        </p>
                        <p>
                           Відповідно до Закону України "Про захист прав
                           споживача" поверненню не підлягає товар належної
                           якості, у тому числі:
                        </p>
                        <ul>
                           <li>
                              Швейні та трикотажні вироби (вироби швейні та
                              трикотажні білизняні, вироби
                              панчішно-шкарпеткові);
                           </li>
                           <li>
                              Вироби та матеріали, що контактують із харчовими
                              продуктами, з полімерних матеріалів, у тому числі
