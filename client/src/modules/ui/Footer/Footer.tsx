            ...
            <div className='footer__container'>
               <div className='footer__logo-container'>
                  ...
                  <p className='label-text'>
                     - це мультибрендовий магазин дитячого-підліткового взуття,
                     де представлене лікувальне, профілактичне та звичайне
                     взуття від світових брендів: SuperFit, GEOX, IMac, Tutubi,
                     Tiflani та інші
                  </p>
               </div>
